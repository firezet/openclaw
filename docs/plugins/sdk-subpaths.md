...
<AccordionGroup>
  <Accordion title="Channel subpaths">
    ...
    | `plugin-sdk/channel-message` | Message lifecycle contract helpers such as `defineChannelMessageAdapter`, durable-final capability derivation, `MessageSendContext`, `RenderedMessageBatch`, and message receipt types |
